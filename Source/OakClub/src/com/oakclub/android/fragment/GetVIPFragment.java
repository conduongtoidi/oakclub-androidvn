...
public class GetVIPFragment {
			...
			public void run() {
				...
				mHelper.startSetup(new IabHelper.OnIabSetupFinishedListener() {
					public void onIabSetupFinished(IabResult result) {
						...
						//Neu goi mHelper.getAllSKU( IabHelper.ITEM_TYPE_INAPP, mGetAllSkuDetailListener); thi bo cac dong code ben duoi
			...
			if (sku.getSku().equals(Constants.PRODUCT_IDS[0])) {
				...
				tvPricePackage2
						.setText(RichTextHelper.getRichText(String.format(
								...
								(Double.parseDouble(sku.getPrice()) / 3) + "")));
				tvBillPackage2
				...
				tvPricePackage3
						.setText(RichTextHelper.getRichText(String.format(
								activity.getString(R.string.txt_USD_month),
								(Double.parseDouble(sku.getPrice()) / 6) + "")));
				tvBillPackage3
						.setText(String.format(
								activity.getString(R.string.txt_billed),
								sku.getPrice()));
				...
				tvPricePackage4
						.setText(RichTextHelper.getRichText(String.format(
								activity.getString(R.string.txt_USD_month),
								(Double.parseDouble(sku.getPrice()) / 12) + "")));
				tvBillPackage4
						.setText(String.format(
								activity.getString(R.string.txt_billed),
								sku.getPrice()));
	...
	IabHelper.OnIabPurchaseFinishedListener mPurchaseFinishedListener = new IabHelper.OnIabPurchaseFinishedListener() {
		public void onIabPurchaseFinished(IabResult result, Purchase purchase) {
			...
			Log.d(TAG, "Purchase success ful.");
			// xac nhan la VIP user len server
			SendRegisterVIP loader = new SendRegisterVIP(
		...
		public void onClick(View v) {
			...
			case R.id.btn_get_vip:
				...
				if (OakClubUtil.isInternetAccess(activity)) {
					enableDialogWarning(activity,
							activity.getString(R.string.txt_vip_room),
							activity.getString(R.string.txt_vip_room_message));
					btn_get_vip_package.setEnabled(true);
//					if (SKU_ID != "") {
...
//					}
	...
	class SendRegisterVIP extends RequestUI {
		SenRegisterVIPReturnObject obj;
		private Purchase purchase;

		public SendRegisterVIP(Object key, Activity activity, Purchase purchase) {
			super(key, activity);
		...
		public void execute() throws Exception {
			obj = activity.oakClubApi.SendRegisterVIP(
					activity.getPackageName(), SKU_ID, purchase.getToken());
		}
