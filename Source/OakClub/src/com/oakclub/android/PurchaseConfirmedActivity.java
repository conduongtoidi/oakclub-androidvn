...
public class PurchaseConfirmedActivity extends OakClubBaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.popup_purhcase_confirmed);
		...
		if (intent != null) {
			pirceString = intent.getStringExtra(Constants.PURCHASE_PRICE);
			transactionId = intent.getStringExtra(Constants.TRANSACTION_ID);
		}
		price.setText( RichTextHelper.getRichText( String.format(
				getString(R.string.txt_purchase_confirmed_price),pirceString)));
