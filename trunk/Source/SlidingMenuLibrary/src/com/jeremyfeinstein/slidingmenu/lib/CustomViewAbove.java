...
public class CustomViewAbove extends ViewGroup {
	...
	public void drawShadow(View content, Canvas canvas) {
		...
		if (mShadowDrawable == null || content.getRight() <= 0) return;
		mShadowDrawable.setAlpha((int)(0xff*getPercentOpen()));
		mShadowDrawable.setBounds(left, 0, left + content.getRight(), getHeight());
