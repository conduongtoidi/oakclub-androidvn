...
public class GCMIntentService extends GCMBaseIntentService {
    ...
    protected void onMessage(Context context, Intent intent) {
        ...
        String notification = intent.getExtras().getString("chat");
        Log.v("chat glm", notification);
        //String message = intent.getExtras().getString("content");
        // notifies user
        boolean isLoad = OakClubUtil.isForeground("com.oakclub.android", this);
    ...
    protected void onRegistered(Context context, String registerId) {
        ...
        oakClubApi.sendRegister(OakClubBaseActivity.facebook_user_id, OakClubBaseActivity.access_token, "3", LoginBaseActivity.appVer, LoginBaseActivity.nameDevice, registerId);
